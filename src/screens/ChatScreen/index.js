...
import { getRoomMessages, createWebSocketConnection } from '../../config/apiClient';
  ...
  return (
    <View style={[
      ...
      <Text style={[
        ...
        isSystemMessage ? styles.systemMessageContent : 
...
const ChatScreen = ({ route, navigation }) => {
  ...
  const handleSendMessage = () => {
    ...
    setSending(true);
    try {
      wsRef.current.sendMessage(newMessage.trim());
      setNewMessage('');
    } catch (error) {
